...
void grabGoalPutInPark() {
	...
	rightmotorval = -35;
	movethemotors();
	wait1Msec(place value here);
	/*leftmotorval = 0;
	rightmotorval = 0;
	movethemotors();*/

	moveDistanceForward(30,30,4000);			//comment this out if you decide to use the other one... line 667-673
	...
	turnLeft(130);												//comment this out if you decide to use the other one... line 677-683

	moveDistanceBackward(30,35,4000);
	turnLeft(35);
	moveDistanceBackward(50,35,4000);
	//turnLeft(25);
...
void scoreGoal3() {
	StartTask(moveDownDrawBridge);
	wait10Msec(1000);
	moveDistanceBackward(40, 45, 5000);
	wait10Msec(500);
	motor[liftMotor1] = -100;
	motor[liftMotor2] = -100;
	wait10Msec(1000);
	motor[flapTrackMotor] = 60;
	wait10Msec(500);
	motor[flapTrackMotor] = 0;
	wait10Msec(1000);
	returnLift();
...
void scoreGoal2() {
	StartTask(moveDownDrawBridge);
	wait10Msec(1000);
	moveDistanceBackward(20, 45, 2000);
	turnLeft(30);
	moveDistanceBackward(30, 45, 3000);
	turnRight(67);
	motor[liftMotor1] = -100;
	motor[liftMotor2] = -100;
	wait10Msec(1000);
...
void scoreGoal1() {
	...
	moveDistanceBackward(20, 45, 2000);
	turnLeft(30);
	moveDistanceBackward(60, 45, 3000);
	turnRight(98);
	moveDistanceBackward(3, 20, 1000);
	motor[liftMotor1] = -100;
	motor[liftMotor2] = -100;
	wait10Msec(1000);
	motor[flapTrackMotor] = 60;
...
//	moveDistanceBackward(15,30,2000);
